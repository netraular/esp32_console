...
const char *MenuView::view_options[] = {
    "Daily Summary", "Pet Status", "Pet Collection", "Pet Hub", "Test Microphone", "Test Speaker", "Test SD Card",
...
const view_id_t MenuView::view_ids[] = {
    VIEW_ID_DAILY_SUMMARY, VIEW_ID_PET_VIEW, VIEW_ID_PET_COLLECTION, VIEW_ID_PET_HUB, VIEW_ID_MIC_TEST, VIEW_ID_SPEAKER_TEST, VIEW_ID_SD_TEST,
    ...
    VIEW_ID_VOLUME_TESTER, VIEW_ID_HABIT_MANAGER, VIEW_ID_ADD_NOTIFICATION, VIEW_ID_NOTIFICATION_HISTORY, VIEW_ID_DAILY_JOURNAL
};
